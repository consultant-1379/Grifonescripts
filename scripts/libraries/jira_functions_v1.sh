...
readonly JIRA_USER='MBTGWBYEBQ'
readonly JIRA_PASSWORD='UADyaxhCDYekTcge3zHck8km'
readonly JIRA_ISSUE_URL='https://eteamproject.internal.ericsson.com/rest/api/2/issue/'
readonly JIRA_JQL_URL='https://eteamproject.internal.ericsson.com/rest/api/2/search?jql='
...
jql_grifone="project='DE%20Test%20Services'%20AND%20component='Team%20Grifone'%20AND%20"
...
jira_return=$(jira_jql $jql_query | jq -r ".issues[] | [.key,.fields.summary,.fields.status.name,.fields.customfield_12328] | @csv")
...
#jql_query="labels%20in%20($label)"
